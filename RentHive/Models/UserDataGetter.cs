namespace RentHive.Models
{
    public class UserDataGetter
    {
        ...
        public string SumItem { get; set; }
        public string SumLivingSpaces { get; set; }
        public string SumStorage { get; set; }
        public string CountItem { get; set; }
        public string CountLivingSpaces { get; set; }
        public string CountStorage { get; set; }
        ...
        public string UnvailableCount { get; set; }
