...
document.addEventListener("DOMContentLoaded", () => {
    ...
    editButton.addEventListener("click", () => {
        ...
        userQuestion.removeAttribute("readonly");
        userQuestion.style.pointerEvents = "";

        userEnail.removeAttribute("readonly");
        userPassword.removeAttribute("readonly");
        userAnswer.removeAttribute("readonly");
    ...
    saveButton.addEventListener("click", () => {
        ...
        userQuestion.setAttribute("readonly", "readonly");
        userEmail.setAttribute("readonly", "readonly");
        userPassword.setAttribute("readonly", "readonly");
        userAnswer.setAttribute("readonly", "readonly");
